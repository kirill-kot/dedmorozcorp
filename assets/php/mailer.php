...
$error = '';
	...
	if(!$date) {
		$error = 'Пожалуйста, выберите удобную для вас дату';
	}
	if(!$error) {
									  ...
									  <table width="600 " align="left " border="0 " cellpadding="0 " cellspacing="0 ">
										<tr>
											<td style="padding: 20px 0; ">
												<img style="max-width:600px;padding-bottom:0;display:inline!important;vertical-align:bottom;border:0;height:auto;outline:none;text-decoration:none " src="http://animatoric.ru/assets/img/LOGO.jpg " width="480 " height="280 " border="0 " alt=" " / >
											</td>
											</tr>
											<tr>
											<td style="padding: 0; ">
												  ...
												  <table width="600px " color="#ffffff " border="0 " cellspacing="0 " cellpadding="0 " border-radius="20px " style="width: 100%; max-width: 600px; border-radius: 20px; ">
													<tr>
													  <td class="bodycopy " style="padding: 40px; color:#ffffff; ">
														...
														<p style="color: #ffffff; text-shadow: 0 1px 1px rgba(8, 37, 54, 0.75);">
															Спасибо. Корпорация Деда Мороза
														</p>
													  </td>
													</tr>
												  </table>
...
<html xmlns="http://www.w3.org/1999/xhtml>
	...
	<body yahoo bgcolor="#f6f8f1 ">
	<table class="content " color="#ffffff " align="left " border="0 "  bgcolor="#4cc1e2 " cellpadding="0 " cellspacing="0 " style="background-image: url("http://animatoric.ru/assets/img/bg_snow_dots.png"); background-size: cover; width: 100%; max-width: 600px; border-radius: 10px; -webkit-border-radius: 10px; -moz-border-radius: 10px; -khtml-border-radius: 10px; ">
		<td>
		  <table width="600px " color="#ffffff " border="0 " cellspacing="0 " cellpadding="0 " border-radius="20px " style="width: 100%; max-width: 600px; border-radius: 20px; ">
			<tr>
...
$__smtp = array(
	...
	"from" => 'animatoric@yandex.ru', // имя отправителя
	"addreply" => trim($_POST['email']), // адрес куда отвечать (обязательно)
	"username" => 'animatoric@yandex.ru', // логин почтового сервера
	"password" => 'start97531', // пароль к почте
);
...
try {
  ...
  $mail->addReplyTo('animatoric@yandex.ru', 'Корпорация Деда Мороза');
  $mail->SetFrom('animatoric@yandex.ru', 'Корпорация Деда Мороза');
